    ...
    <span>Status</span>
     <div class="status-button flex"
         ...
         >
          ...
          <span v-if="currentInvoice.invoicePending">Draft</span>
          <span v-if="currentInvoice.invoiceDraft">Pending</span>
         </div>
  </div>
  <div class="right flex">
<button @click="toggleInvoiceEdit" class="purple">Edit</button>
<button @click="deleteInvoice(currentInvoice.docId)" class="red">Delete</button>
<button @click="updateStatusToPaid(currentInvoice.docId)" class="green" v-if="currentInvoice.invoicePending">Mark as Paid</button>
<button @click="updateStatusToPending(currentInvoice.docId)" class="orange" v-if="currentInvoice.invoicePaid || currentInvoice.invoiceDraft">Mark as Pending</button>
  </div>
</div>
...
created(){
  this.$store.commit('currentInvoiceArray',this.$route.params.invoiceId)
...
methods:{
  ...
  deleteInvoice(docId){
    this.$store.dispatch('deleteInvoice',docId)
